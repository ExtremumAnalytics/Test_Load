...
document.addEventListener('DOMContentLoaded', function() {
    ...
    socket.emit('get_dropdown_data');

    socket.on('dropdown_data', function(data) {
        if (data.error) {
            alert(data.error);
            return;
        }

        const doctorsDropdown = document.getElementById('selectDoctor');
        const productsDropdown = document.getElementById('selectProduct');

        // Populate doctors dropdown
        data.doctors.forEach(doctor => {
            const option = document.createElement('option');
            option.value = doctor.doctors;  // Assuming there's an 'id' column in your CSV
            option.text = doctor.doctors;  // Assuming there's a 'name' column in your CSV
        ...
        data.products.forEach(product => {
            const option = document.createElement('option');
            option.value = product.products;  // Assuming there's an 'id' column in your CSV
            option.text = product.products;  // Assuming there's a 'name' column in your CSV
